  ...
  const Cards = () => {
    const cards = [
      ...
      },
      {
        ...
        paragraphe: "Focus with soft study music in the .",
      },
      {
        img: image18,
        titre: "Focus Flow",
        paragraphe: "Uptempo instrumental hip hopbeats the ",
      },
      {
        img: image19,
      ...
      },
      {
        ...
        paragraphe: "Harry Styles is on top of the Hottest 50! hottest top artist styles",
      },
      {
        img: image21,
        titre: "RapCaviar",
        paragraphe: "New music from Lil Baby, Gucci Mane and DaBaby hottest 50.",
      },
      {
        img: image22,
        titre: "All Out 2010s",
      ...
      },
      {
        img: image23,
        titre: "Rock Classics",
        paragraphe: "Rock legends & epic songs that continue to inspire... Hottest artist",
      },
      {
        img: image24,
        titre: "Chill Hits",
        paragraphe: "Kick back to the best new and recent chill hits Meek Mill. Black Mafia",
      },
    ];
    return (
